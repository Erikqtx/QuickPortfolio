...
function Datenschutz() {
  return (
    <div class="text-center font-semibold text-2xl">
      ...
      <p>
        E-Mail-Adresse:{" "}
        <a href="mailto:glaser-erik@web.de">glaser-erik@web.de</a>.
      </p>
      <p>
        Impressum:{" "}
        <a href="http://erikglaser.de/impressum" target="_blank">
          http://erikglaser.de/impressum
        </a>
        .
      </p>
      ...
      <p>
        ...
        mithilfe vergleichbarer Technologien) erfolgen, um die Einwilligung
        ...
        gelten die folgenden Hinweise: Die Dauer der Speicherung der
      ...
      <ul class="m-elements">
        <li>
          ...
          Gunzenhausen, Deutschland; Website:{" "}
